...
- **Open Source:** CarbonClicks is open source, licensed under the AGPLv3. The software is "copyleft" and free to self-host and distribute.
...
Now, after months of writing CarbonClicks, I'm thrilled to be able to offer this new code base for free to everyone who wants to measure their website's carbon emissions accurately and in real-time. The license chosen enables anyone to distribute, sell, modify and build on this software as long as they keep the same license and make their source code available (see the [AGPLv3 license](https://www.gnu.org/licenses/agpl-3.0.en.html) for more information). This ethos fits well with the values that brought the team at Neuto together and latterly the work done by [Considerate Digital](https://considerate.digital).
...
## License
CarbonClicks is distributed under [AGPLv3](https://www.gnu.org/licenses/agpl-3.0.en.html). The name "CarbonClicks" and the associated logo are trademarked.
